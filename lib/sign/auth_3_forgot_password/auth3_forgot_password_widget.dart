                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '4c9m8ftn' /* Missione Cattolica Italiana */,
                                            ),
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: FlutterFlowIconButton(
                                          ...
                                          borderWidth: 1.0,
                                          buttonSize: 40.0,
                                          fillColor: const Color(0xFFBAD2EE),
                                          icon: Icon(
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'k1eucaoo' /* Inserisci la tua email qui sot... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge
                                              .override(
                                            ...
                                            decoration: InputDecoration(
                                              labelText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                '258d3oqj' /* Il tuo indirizzo email */,
                                              ),
                                              labelStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
